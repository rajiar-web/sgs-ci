    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">Age Range</h3>
           ...
           <?=form_open('',array("id"=>"cform"));?>
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" id="cid" name="cid" value="<?php if (isset($agedata)){ echo $agedata[0]->a_id; } ?>">
                    <div class="col-md-12">
                       <div class="form-group">
                      <label for="exampleInputEmail1">Age Range<span class="compulsory">*</span></label>
                      <input type="text" class="form-control" id="age" name="age" placeholder="Eg, 20-30" value="<?php if (isset($agedata)){ echo $agedata[0]->a_age_range; } ?>" >
                    </div>
                    <span id="age_error" class="validation-error"></span>
                    </div>
