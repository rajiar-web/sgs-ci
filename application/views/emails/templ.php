...
<head>
  ...
  <style type="text/css" media="screen">
    ...
    .gradient { background: linear-gradient(to right, #0e1a32 0%,#4ab8b4 100%); }
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="mpx-10">
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                        <a href="#" target="_blank"><img src="<?=base_url()?>assets/front/assets/images/logo.png" width="300" height="100" border="0" alt="" /></a>
                                      </td>
                                    </tr>
                                  </table>
                                  <!-- Logo -->
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="px-50 mpx-15" style="padding-left: 50px; padding-right: 50px;">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td class="pb-50" style="padding-bottom: 5px;">

                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              
                                                <tr>
                                                  <td class="title-36 a-center pb-10" style="font-size:36px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 10px;">
                                                    You got a enquiry from <strong> <?= $name ?>!</strong>
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td class="title-22 a-center pb-15" style="font-size:22px; line-height:26px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                  ...
                                                  <td class="title-22 a-center pb-15" style="font-size:22px; line-height:26px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                   ...
                                                   <tr>
                                                 <td class="title-22 a-center pb-15" style="font-size:22px; line-height:26px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                    Phone:  <strong><a href="tel:<?= $contactno ?>"><?= $contactno ?></a></strong>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td class="p-50 mpx-15" style="border-radius: 0 0 10px 10px; padding: 50px;background: linear-gradient(27deg, rgba(69,154,82,1) 0%, rgba(39,65,128,1) 100%);">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
