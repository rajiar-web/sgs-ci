    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">Concerns</h3>
           ...
           <?=form_open('',array("id"=>"cform"));?>
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" id="cid" name="cid" value="<?php if (isset($concernsdata)){ echo $concernsdata[0]->cons_id; } ?>">
                    <div class="col-md-12">
                       <div class="form-group">
                      <label for="exampleInputEmail1">Concerns<span class="compulsory">*</span></label>
                      <input type="text" class="form-control" id="concerns" name="concerns" placeholder="Enter Concerns" value="<?php if (isset($concernsdata)){ echo $concernsdata[0]->cons_concern; } ?>" >
                    </div>
                    <span id="concerns_error" class="validation-error"></span>
                    </div>
