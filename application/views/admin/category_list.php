...
<tr>
                      ...
                      <td><?=$r->c_category; ?></td>
                      <td><?=$r->c_name; ?></td>
                      <td><?=($r->c_status=='1'?'active':'inactive');?></td>
                       
                        <td>  <a href="add-category/<?=$r->c_id;?>"  class="btn edit-cat btn-info" title="Edit"> <i class="fa fa-edit"></i></a>
                         
                     <a href="javascript:void(0)" id="<?=$r->c_id;?>" class="btn del-category  btn-danger" title="Delete"> <i class="fa fa-trash"></i></a></td>
