...
Add</button></a>
              <h3 class="card-title">Best Sellers
                    ...
                    foreach($records as $index=>$r)
                    {
                     ...
                     $images = $r->image;
                      ...
                      <td><?=$r->dis_rate; ?></td>
                        ...
                        <td>  <a href="add-best-sellers/<?=$r->id;?>"  class="btn edit-cat btn-info" title="Edit"> <i class="fa fa-edit"></i></a>
                         
                     <a href="javascript:void(0)" id="<?=$r->id;?>" class="btn del-best-sellers  btn-danger" title="Delete"> <i class="fa fa-trash"></i></a>
