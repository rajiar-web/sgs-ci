  ...
  <div class="content-wrapper">
    ...
    <tbody>
        <?php  $i=1; foreach($records as $r) {
           if($r->u_status == 1) { ?>
            <tr id="tbodytr<?=$r->u_id;?>" style="font-weight: bold;color : blue;">
      
        <td><?php echo $i++;?></td>
       <?php  echo "<td>".$r->u_first_name."</td>";  ?>
       <?php  echo "<td>".$r->u_last_name ."</td>";  ?>
       <?php  echo "<td>".$r->u_email."</td>";  ?>
       <?php  echo "<td>".$r->u_phone."</td>";  ?>
     <?php  echo "<td>".$r->u_created_date."</td>";  ?>
     <td>
                         
     <a href="javascript:void(0)" id="<?=$r->u_id;?>" class="btn view-cat btn-success" title="View <?=$r->u_first_name;?>" > <i class="fa fa-eye"></i></a>
...
<script src="<?=admin_custom_js();?>search.js"></script>
