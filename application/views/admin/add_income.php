    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">Lack of Income</h3>
           ...
           <?=form_open('',array("id"=>"cform"));?>
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" id="cid" name="cid" value="<?php if (isset($incomedata)){ echo $incomedata[0]->l_id; } ?>">
                ...
                <div class="col-md-12">
                      ...
                      <textarea class="form-control" id="desc" name="desc" placeholder="Enter Description"><?php if (isset($incomedata)) echo $incomedata[0]->l_description; ?></textarea>
