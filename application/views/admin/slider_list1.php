...
<?php $this->load->view('admin/inc/sidebar');?>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <!-- <div class="col-md-12 text-center pt-2">
              <a href="<?=base_url('add-offer');?>"  class="btn edit-cat btn-info" title="Add"> <i class="fa fa-plus"></i>Add Offer</a>
            </div> -->
  ...
  <!-- Main Footer -->
   ...
   <div class="modal" tabindex="-1" role="dialog" id="ofrModal">
    <?//=form_open('',array("id"=>"mnuofr"));?>
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title main-modal-title text-info" >Slider List</h5>
