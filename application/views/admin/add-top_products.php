    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">Home Top Products</h3>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <textarea class="form-control" id="desc" name="desc" placeholder="Enter Original Price"> <?php if (isset($records)){ echo $records[0]->des; } ?></textarea>
                    </div>
...
<script src="<?=admin_custom_js();?>top_products.js"></script>
