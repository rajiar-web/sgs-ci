    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">Country</h3>
           ...
           <?=form_open('',array("id"=>"cform"));?>
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" id="cid" name="cid" value="<?php if (isset($countrydata)){ echo $countrydata[0]->c_id; } ?>">
                    <div class="col-md-12">
                       <div class="form-group">
                      <label for="exampleInputEmail1">Country<span class="compulsory">*</span></label>
                      <input type="text" class="form-control" id="country" name="country" placeholder="Enter Country" value="<?php if (isset($countrydata)){ echo $countrydata[0]->c_country; } ?>" >
                    <!-- </div> -->
                    <span id="country_error" class="validation-error"></span>
                    </div>
...
<script src="<?=admin_custom_js();?>country.js"></script>
