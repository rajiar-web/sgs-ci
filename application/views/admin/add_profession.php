    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">Profession</h3>
           ...
           <?=form_open('',array("id"=>"cform"));?>
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" id="cid" name="cid" value="<?php if (isset($professiondata)){ echo $professiondata[0]->p_id; } ?>">
                    <div class="col-md-12">
                       <div class="form-group">
                      <label for="exampleInputEmail1">Profession<span class="compulsory">*</span></label>
                      <input type="text" class="form-control" id="profession" name="profession" placeholder="Enter Profession" value="<?php if (isset($professiondata)){ echo $professiondata[0]->p_profession; } ?>" >
                    </div>
                    <span id="profession_error" class="validation-error"></span>
                    </div>
...
<script src="<?=admin_custom_js();?>profession.js"></script>
