                    ...
                    foreach($plist as $index=>$l)
                    {
                     $img = '';
                      ...
                      <tr>
                       ...
                       <td>
                       <a href="<?=base_url()?>add-services/<?=$l->s_id;?>" id="<?=$l->s_id;?>" class="btn edit-slider  btn-primary" title="Edit <?=$l->s_title;?>"> <i class="fa fa-edit"></i></a>
                       <a href="javascript:void(0)" id="<?=$l->s_id;?>" class="btn del-services  btn-danger" title="Delete <?=$l->s_title;?>"> <i class="fa fa-trash"></i></a>
