...
Add</button></a>
              <h3 class="card-title">What is your profession?
    ...
    <tbody>
       ...
       <?php  echo "<td>".$r->p_profession."</td>";  ?>
      
    
     <?php echo "<td>".($r->p_status=='1'?'active':'inactive');"</td>" ; ?> 
     <td>
                         
                          <a href="addprofession/<?=$r->p_id;?>"  class="btn edit-cat btn-info" title="Edit <?=$r->p_profession;?>"> <i class="fa fa-edit"></i></a>
                          <a href="javascript:void(0)" id="<?=$r->p_id;?>" class="btn del-profession  btn-danger" title="Delete <?=$r->p_profession;?>"> <i class="fa fa-trash"></i></a>
