...
Add</button></a>
              <h3 class="card-title">Top Products
                    ...
                    foreach($records as $index=>$r)
                    {
                     ...
                     $images = $r->image;
                      ...
                      <td><?=$r->link; ?></td>
                        ...
                        <td>  <a href="add-top-products/<?=$r->id;?>"  class="btn edit-cat btn-info" title="Edit"> <i class="fa fa-edit"></i></a>
                         
                     <a href="javascript:void(0)" id="<?=$r->id;?>" class="btn del-top-products  btn-danger" title="Delete"> <i class="fa fa-trash"></i></a>
