         ...
         <?php if(!empty($records))
                  {
                    ...
                    foreach($records as $index=>$r)
                    {
                      ...
                      <tr>
                      <td><?=$i++;?></td>
                      <td><?=$r->pc_classification; ?></td>
                        <td><?=($r->pc_status=='1'?'active':'inactive');?></td>
                        
                       
                        
                       
                        <td>  <a href="add-classification/<?=$r->pc_id;?>"  class="btn edit-cat btn-info" title="Edit"> <i class="fa fa-edit"></i></a>
                         
                     <a href="javascript:void(0)" id="<?=$r->pc_id;?>" class="btn del-classification  btn-danger" title="Delete"> <i class="fa fa-trash"></i></a></td>
