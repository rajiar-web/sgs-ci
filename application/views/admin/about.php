    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">About</h3>

         
        </div>
              <?=form_open('addAbout',array("id"=>"about"));?>
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" id="comId" name="comId" value="<?php echo(!empty($aboutdata)?$aboutdata[0]->a_id:''); ?>">
                    ...
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="<?php echo (!empty($aboutdata)?$aboutdata[0]->a_title:""); ?>">
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Top Description<span class="compulsory">*</span></label>
                        <textarea class="form-control" id="desc" name="desc" placeholder="Enter Description"><?php if (!empty($aboutdata)) echo $aboutdata[0]->a_top_des; ?></textarea>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Bottom Description<span class="compulsory">*</span></label>
                        <textarea class="form-control" id="desc2" name="desc2" placeholder="Enter Description"><?php if (!empty($aboutdata)) echo $aboutdata[0]->a_bottom_des; ?></textarea>
                        <span id="desc_error" class="validation-error"></span>
                      </div> 
                    </div>
...
<script src="<?=admin_custom_js();?>about.js"></script>
