    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="main-card-title card-title">Reasons</h3>
           ...
           <?=form_open('',array("id"=>"cform"));?>
                <div class="card-body">
                  <div class="row">
                    <input type="hidden" id="cid" name="cid" value="<?php if (isset($reasonsdata)){ echo $reasonsdata[0]->r_id; } ?>">
                    <div class="col-md-12">
                       <div class="form-group">
                      <label for="exampleInputEmail1">Title<span class="compulsory">*</span></label>
                      <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="<?php if (isset($reasonsdata)){ echo $reasonsdata[0]->r_title; } ?>" >
                    </div>
