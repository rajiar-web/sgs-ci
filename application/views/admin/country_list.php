...
Add</button></a>
              <h3 class="card-title">Choose your Country
    ...
    <tbody>
       ...
       <?php  echo "<td>".$r->c_country."</td>";  ?>
      
    
     <?php echo "<td>".($r->c_status=='1'?'active':'inactive');"</td>" ; ?> 
     <td>
                         
                          <a href="addcountry/<?=$r->c_id;?>"  class="btn edit-cat btn-info" title="Edit <?=$r->c_country;?>"> <i class="fa fa-edit"></i></a>
                          <a href="javascript:void(0)" id="<?=$r->c_id;?>" class="btn del-country  btn-danger" title="Delete <?=$r->c_country;?>"> <i class="fa fa-trash"></i></a>
